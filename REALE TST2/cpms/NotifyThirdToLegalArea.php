...
/**
* CPMObjectEventHandler: NotifyThirdToLegalArea
* Package: RN
* Objects: Incident
* Actions: Update
* Version: 1.3
...
*/
class NotifyThirdToLegalArea implements RNCPM\ObjectEventHandler
{
  /**
...
class NotifyThirdToLegalArea_TestHarness implements RNCPM\ObjectEventHandler_TestHarness
{
