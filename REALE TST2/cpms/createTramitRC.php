...
/**
 * CPMObjectEventHandler: createTramitRC
 * Package: RN
 * Objects: Incident
 * Actions: Update
 * Version: 1.3
 * Purpose: Crear tramite sobre Responsabilidad Civil.
 */
...
require_once APPPATH . "libraries/cpm/v1/createTramitRC.php";

/**
 * Handler class for CPM.
 */
class createTramitRC implements RNCPM\ObjectEventHandler
{
  /**
  ...
  public static function apply($runMode, $action, $incident, $cycle)
  {
    ...
    try
    {
      return CPMHandlers\createTramitRC::execute($runMode, $action, $incident, $cycle);
    }
...
class createTramitRC_TestHarness implements RNCPM\ObjectEventHandler_TestHarness
{
