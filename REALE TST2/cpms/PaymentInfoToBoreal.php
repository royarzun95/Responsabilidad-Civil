...
/**
 * CPMObjectEventHandler: PaymentInfoToBoreal
 * Package: RN
 * Objects: Incident
 * Actions: Update
 * Version: 1.3
...
define('APPPATH',
  ...
  require_once APPPATH . "libraries/cpm/v1/PaymentInfoToBoreal.php";

/**
 * Handler class for CPM.
 */
class PaymentInfoToBoreal implements RNCPM\ObjectEventHandler
{
  /**
  ...
  public static function apply($runMode, $action, $incident, $cycle)
  {
    ...
    try
    {
      return CPMHandlers\PaymentInfoToBoreal::execute($runMode, $action, $incident, $cycle);
    }
...
class PaymentInfoToBoreal_TestHarness implements RNCPM\ObjectEventHandler_TestHarness
{
