...
/**
* CPMObjectEventHandler: NotifyThirdWithoutCover
* Package: RN
* Objects: Incident
* Actions: Update
* Version: 1.3
* Purpose: Notificación al Tercero por el incidente padre sin cobertura
*/
...
*/
class NotifyThirdWithoutCover implements RNCPM\ObjectEventHandler
{
  /**
    ...
    try
    {
      ...
      if ($incident->PrimaryContact)
      {
        ...
        if (!empty($a_contact_emails))
        {
          ...
          $html_message_base_name = 'CUSTOM_MSG_RC_WITHOUT_COVER';
...
class NotifyThirdWithoutCover_TestHarness implements RNCPM\ObjectEventHandler_TestHarness
{
