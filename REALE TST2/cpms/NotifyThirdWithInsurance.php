...
/**
* CPMObjectEventHandler: NotifyThirdWithInsurance
* Package: RN
* Objects: Incident
* Actions: Update
* Version: 1.3
* Purpose: Notificación al Tercero por tener Aseguradora
*/
...
*/
class NotifyThirdWithInsurance implements RNCPM\ObjectEventHandler
{
  /**
  ...
  */
  public static function apply($runMode, $action, $incident, $cycle)
  {
    ...
    try
    {
        $subject = "Cierre de atención siniestro Responsabilidad Civil";
        ...
        if ($incident->PrimaryContact)
        {
            ...
            if (!empty($a_contact_emails))
            {
                ...
                $html_message_base_name = 'CUSTOM_MSG_RC_THIRD_WITH_ENSURANCE_AND_DONT_WANT_REALE';
...
class NotifyThirdWithInsurance_TestHarness implements RNCPM\ObjectEventHandler_TestHarness
{
