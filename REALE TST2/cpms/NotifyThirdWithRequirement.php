...
/**
* CPMObjectEventHandler: NotifyThirdWithRequirement
* Package: RN
* Objects: Incident
* Actions: Update
* Version: 1.3
...
*/
class NotifyThirdWithRequirement implements RNCPM\ObjectEventHandler
{
  /**
  ...
  */
  public static function apply($runMode, $action, $incident, $cycle)
  {
    ...
    try
    {
      $subject = "Solicitud Documentos atención Responsabilidad Civil";
      ...
      if ($incident->PrimaryContact)
      {
        ...
        if (!empty($a_contact_emails))
        {
          ...
          $html_message_base_name = 'CUSTOM_MSG_RC_DOCUMENT_REQUEST_VIA_EMAIL';
...
class NotifyThirdWithRequirement_TestHarness implements RNCPM\ObjectEventHandler_TestHarness
{
